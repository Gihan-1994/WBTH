                    ...
                    <div className="p-6">
                        <div className="flex items-start gap-5 mb-6">
                            {profile.profile_picture ? (
                                ...
                                <div className="w-20 h-20 rounded-xl bg-blue-50 flex items-center justify-center border border-blue-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg">
                                ...
                                <p className="text-gray-900 font-medium ml-7">{profile.country || "Not provided"}</p>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        Receive booking updates and confirmations via email
                                    </p>
                                </div>
                            </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm font-medium text-gray-900">Tourist</span>
                        </div>
                    </div>
                </div>
            </div>
